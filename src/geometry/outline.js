...
/**
 * Прямоугольный контур, раздвинутый на d наружу от материала. Рёбра на
 * габарите не двигаются: внешние грани детали плоские, фаска на них не
 * заходит. Число вершин сохраняется — на этом держится соответствие контуров.
 */
